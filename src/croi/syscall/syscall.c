...
i64 Croi_Syscall_Dispatch(struct TrapFrame *frame)
{
    ...
    // ---- BOOPSI public class registry (L7) ----
    case SYS_FindClass:
        return (i64)(uptr)Croi_FindClass_Impl((STRPTR)(uptr)a0);
    case SYS_AddClass:
        Croi_Boopsi_RegisterClass((struct IClass *)(uptr)a0);
        return 0;
    ...
    case SYS_Iff_InitIFFasDOS:
        ...
        return 0;
    case SYS_Iff_ParseIFF:
        return (i64)Croi_Iff_ParseIFF_Impl((struct IFFHandle *)(uptr)a0, (LONG)a1);
    case SYS_Iff_ReadChunkBytes:
        return (i64)Croi_Iff_ReadChunkBytes_Impl((struct IFFHandle *)(uptr)a0, (APTR)(uptr)a1,
                                                 (LONG)a2);
    case SYS_Iff_ReadChunkRecords:
        return (i64)Croi_Iff_ReadChunkRecords_Impl((struct IFFHandle *)(uptr)a0, (APTR)(uptr)a1,
                                                   (LONG)a2, (LONG)a3);
    case SYS_Iff_StopChunk:
        return (i64)Croi_Iff_StopChunk_Impl((struct IFFHandle *)(uptr)a0, (LONG)a1, (LONG)a2);
    case SYS_Iff_StopOnExit:
        return (i64)Croi_Iff_StopOnExit_Impl((struct IFFHandle *)(uptr)a0, (LONG)a1, (LONG)a2);
    case SYS_Iff_CurrentChunk:
    ...
    case SYS_Iff_WriteChunkRecords:
        return (i64)Croi_Iff_WriteChunkRecords_Impl((struct IFFHandle *)(uptr)a0, (APTR)(uptr)a1,
                                                    (LONG)a2, (LONG)a3);
    case SYS_Iff_PropChunk:
        return (i64)Croi_Iff_PropChunk_Impl((struct IFFHandle *)(uptr)a0, (LONG)a1, (LONG)a2);
    case SYS_Iff_PropChunks:
        return (i64)Croi_Iff_PropChunks_Impl((struct IFFHandle *)(uptr)a0, (LONG *)(uptr)a1,
                                             (LONG)a2);
    case SYS_Iff_CollectionChunk:
        return (i64)Croi_Iff_CollectionChunk_Impl((struct IFFHandle *)(uptr)a0, (LONG)a1, (LONG)a2);
    case SYS_Iff_CollectionChunks:
        return (i64)Croi_Iff_CollectionChunks_Impl((struct IFFHandle *)(uptr)a0, (LONG *)(uptr)a1,
                                                   (LONG)a2);
    case SYS_Iff_FindProp:
        return (i64)(uptr)Croi_Iff_FindProp_Impl((struct IFFHandle *)(uptr)a0, (LONG)a1, (LONG)a2);
