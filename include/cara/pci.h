...
constexpr u32 CARA_MAX_PCI_RANGES = 8;
...
enum : u16 {
    PCI_CFG_VENDOR_ID = 0x00,   // u16
    PCI_CFG_DEVICE_ID = 0x02,   // u16
    PCI_CFG_COMMAND = 0x04,     // u16
    PCI_CFG_STATUS = 0x06,      // u16
    PCI_CFG_REVISION = 0x08,    // u8
    PCI_CFG_PROG_IF = 0x09,     // u8
    PCI_CFG_SUBCLASS = 0x0A,    // u8
    PCI_CFG_BASE_CLASS = 0x0B,  // u8
    PCI_CFG_CACHE_LINE = 0x0C,  // u8
    PCI_CFG_LATENCY = 0x0D,     // u8
    PCI_CFG_HEADER_TYPE = 0x0E, // u8 (bit7 = multi-function)
    PCI_CFG_BIST = 0x0F,        // u8
    PCI_CFG_BAR0 = 0x10,        // u32
    PCI_CFG_BAR1 = 0x14,
    PCI_CFG_BAR2 = 0x18,
    PCI_CFG_BAR3 = 0x1C,
    PCI_CFG_BAR4 = 0x20,
...
enum : u8 {
    PCI_HEADER_TYPE_GENERAL = 0x00,
    PCI_HEADER_TYPE_BRIDGE = 0x01,
    PCI_HEADER_TYPE_MULTI = 0x80,
};
...
enum : u8 {
    PCI_CLASS_USB_XHCI_BASE = 0x0C,
    PCI_CLASS_USB_XHCI_SUB = 0x03,
    PCI_CLASS_USB_XHCI_PROGIF = 0x30,
};

// ---- Discovered functions ---------------------------------------------------

constexpr u32 CARA_MAX_PCI_BARS = 6;
...
constexpr u32 CARA_MAX_PCI_FUNCTIONS = 32;
