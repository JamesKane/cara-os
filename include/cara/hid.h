...
#define HID_BOOT_REPORT_BYTES        8
...
#define IEQUALIFIER_LCOMMAND         0x0040     // left Amiga / Win
#define IEQUALIFIER_RCOMMAND         0x0080     // right Amiga / Win
