...
// ---- Classic (V1.x) short aliases, verbatim ------------------------------
// The original intuition.h spells the window Flags and IDCMP classes without
// the WFLG_ / IDCMP_ prefixes (those prefixes were added later for clarity).
// Real V36+ source uses either spelling, so both must exist.
...
// Menu checkmark / command glyph widths (V36+ verbatim).
